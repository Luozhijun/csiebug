package csiebug.web.webapp.example.taglib.tab;
...
public class TabAction extends BasicAction {
...
//		}
	...
	private void makeControl() throws UnsupportedEncodingException, NamingException {
		...
		try {
			...
			if(AssertUtility.isNotNullAndNotSpace(getFunctionId())) {
				...
				setRequestAttribute("FunctionName", getMessage("taglibdemo.TabDoc.FunctionName"));
			}
		}
	...
	private void makeTabDIV() {
		Map<String, String> tabMap = new LinkedHashMap<String, String>();
		tabMap.put("Text", "textDIV");
		tabMap.put("Menu", "menuDIV");
		tabMap.put("Code", "codeDIV");
		
		setRequestAttribute("tabMap1", tabMap);
	}
	
	private void makeTabIFrame() {
		Map<String, String> tabMap = new LinkedHashMap<String, String>();
