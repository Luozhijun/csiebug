			            ...
			            try {
				            ...
				            if(!AssertUtility.isTrue(row.getSelectable()) && AssertUtility.isTrue(map.get("selectable"))) {
				            	...
				            	if(map.get("onClick") != null) {
				            		htmlBuilder.onClick("selTDForCopyForExcel('" + table.getId() + "', this, " + (table.getHeaderRowCount() + table.getCurrentMapIndex()) + ", " + (row.getCurrentColumnIndex() + 1) + ", " + table.getHeaderRowCount() + ", event, '" + webutil.getMessage("common.warning") + "', '" + webutil.getMessage("common.confirm.copy") + "', '" + webutil.getMessage("common.ok") + "', '" + webutil.getMessage("common.cancel") + "');" + transScript(map.get("onClick")));
				            		...
				            		if(map.get("onDblClick") != null) {
				            			htmlBuilder.onDblClick("selTDForCopyForExcel('" + table.getId() + "', this, " + (table.getHeaderRowCount() + table.getCurrentMapIndex()) + ", " + (row.getCurrentColumnIndex() + 1) + ", " + table.getHeaderRowCount() + ", event, '" + webutil.getMessage("common.warning") + "', '" + webutil.getMessage("common.confirm.copy") + "', '" + webutil.getMessage("common.ok") + "', '" + webutil.getMessage("common.cancel") + "');" + transScript(map.get("onDblClick")));
				            		} else {
