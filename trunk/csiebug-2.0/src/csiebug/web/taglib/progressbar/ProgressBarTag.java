...
import csiebug.web.html.progressbar.HtmlProgressBar;
 ...
 * @version 2009/6/10
 */
public class ProgressBarTag extends BodyTagSupport implements TryCatchFinally {
	...
	public int doStartTag() throws JspException {
		try { 
            ...
            if(uncomplete != null) {
            	htmlProgressBar = new HtmlProgressBar(Float.parseFloat(uncomplete));
            } else {
            	htmlProgressBar = new HtmlProgressBar(0);
            }
