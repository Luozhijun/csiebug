 ...
 * @version 2009/2/15
 */
public class TextTag extends BodyTagSupport implements TryCatchFinally {
	...
	public int doStartTag() throws JspException {
		try { 
            ...
            HtmlText text = new HtmlText(htmlId, name, isReadOnly, className, isReturnValue, defaultValue, dataType, isMasked, onChange, onBlur, onClick, onKeyDown, header, headerClass, footer, footerClass, buttonClass, isRequired, userValue, opEnum, maxlength, fixlength, size, style, maxvalue, minvalue, maxinteger, maxdecimal, numberStep, imagePath, typesetting);
            
            out.println(text.render());
        } 
        catch(Exception e) {
	...
	public void doCatch(Throwable e) throws Throwable {
		throw new JspException("TextTag Problem: " + e.getMessage());
    }
