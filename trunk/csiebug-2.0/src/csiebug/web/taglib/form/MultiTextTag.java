 ...
 * @version 2010/10/6
 */
public class MultiTextTag extends BodyTagSupport implements TryCatchFinally {
	...
	public int doStartTag() throws JspException {
		try { 
            ...
            HtmlMultiText multiText = new HtmlMultiText(htmlId, name, isReadOnly, className, isReturnValue, defaultValue, dataType, isMasked, onChange, header, headerClass, footer, footerClass, buttonClass, isRequired, userValue, maxlength, fixlength, size, style, maxvalue, minvalue, maxinteger, maxdecimal, imagePath, typesetting);
            
            out.println(multiText.render());
        } 
        catch(Exception e) {
	...
	public void doCatch(Throwable e) throws Throwable {
		throw new JspException("MultiTextTag Problem: " + e.getMessage());
    }
