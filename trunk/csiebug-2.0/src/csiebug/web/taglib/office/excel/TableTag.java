...
import csiebug.web.html.office.excel.HtmlTable;
...
public class TableTag extends BodyTagSupport implements TryCatchFinally {
	...
	public int doStartTag() throws JspException {
		try { 
            ...
            table = new HtmlTable(htmlId, name, projectId, style, className, data, downloadFileName, imagePath, formId, downloadPartial, downloadColumns, highlight);
