...
import csiebug.web.html.office.project.HtmlColumn;
...
public class ColumnTag extends BodyTagSupport implements TryCatchFinally {
	...
	public int doStartTag() throws JspException {
		try {
            ...
            column = new HtmlColumn(rowTag.getRow(), fieldname, style, className, title, dataType, colspan, hideable, selAllScript, selectable, onClick, onDblClick, maxLineLength, typesettingAlgorithm, isReadOnly);
