...
public abstract class LoginScenario extends BasicCommand {
	...
	//測試只輸入密碼
	public void testScenario3() throws InvalidKeyException, InvalidKeySpecException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, UnsupportedEncodingException, DecoderException {
		String username = "";
	...
	//測試csiebug登入正確的情況
	public void testScenario6() throws InvalidKeyException, InvalidKeySpecException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, UnsupportedEncodingException, DecoderException {
		String username = "csiebug";
		String key = "123456789012345678901234123456789012345678901234";
		String encryptPassword = "e9be64df86350eb2";
	...
	//測試test登入正確的情況
	public void testScenario7() throws InvalidKeyException, InvalidKeySpecException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, UnsupportedEncodingException, DecoderException {
