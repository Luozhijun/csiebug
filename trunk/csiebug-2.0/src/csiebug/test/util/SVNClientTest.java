...
public class SVNClientTest {
	...
	@Test
	public void testPrintRepositoryTree() throws SVNException {
		String url = "http://localhost/svn/csiebug/csiebug-2.0/WebContent/example/svn/";
		String name = "csiebug";
		String password = "Ilovepanda";
		SVNClient client = new SVNClient(url, name, password);
...
//		assertEquals(value, client.getRepositoryTreeFormatString(""));
	...
	@Test
	public void testIsTextFile() throws SVNException {
	...
	@Test
	public void testGetTextFileContent() throws SVNException, IOException {
		String url = "http://localhost/svn/csiebug/csiebug-2.0/";
		String name = "csiebug";
		String password = "Ilovepanda";
	...
	@Test
	public void testPrintRepositoryHistory() throws SVNException {
		String url = "http://localhost/svn/csiebug/csiebug-2.0/";
		String name = "csiebug";
		String password = "Ilovepanda";
...
//	@Test
	public void testUpdate() throws SVNException, IOException {
		String url = "http://localhost/svn/csiebug/csiebug-2.0/";
		String name = "csiebug";
		String password = "Ilovepanda";
		SVNClient client = new SVNClient(url, name, password);
