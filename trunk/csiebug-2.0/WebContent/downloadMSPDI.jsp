...
<html>
	...
	<body>
		<form id="downloadProject" name="downloadProject" action="<%=webutil.getBasePathForHTML()%>index" method="POST" target="_self">
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					document.getElementById("ActFlag").value = "downloadMSPDI";
					...
					document.getElementById("downloadProject").submit();
				});
			</script>
			<!-- Javascript區結束 -->
		</form>
