...
<html>
	...
	<body>
		<form id="downloadODS" name="downloadODS" action="<%=webutil.getBasePathForHTML()%>index" method="POST" target="_self">
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					document.getElementById("ActFlag").value = "downloadODS";
					...
					document.getElementById("downloadODS").submit();
				});
			</script>
			<!-- Javascript區結束 -->
		</form>
