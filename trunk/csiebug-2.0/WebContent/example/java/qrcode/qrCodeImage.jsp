...
<html>
	...
	<body>
		...
		<form id="table" name="table" action="<%=webutil.getBasePathForHTML()%>example/table" method="POST">
			...
			<img src="<%=webutil.getBasePathForHTML()%>index?ActFlag=qrCodeImage&QRCodeValue=csiebug@gmail.com" border="1">
			<img src="<%=webutil.getBasePathForHTML()%>index?ActFlag=qrCodeImage&QRCodeValue=csiebug@gmail.com&QRCodeWidth=100&QRCodeHeight=100" border="1">
