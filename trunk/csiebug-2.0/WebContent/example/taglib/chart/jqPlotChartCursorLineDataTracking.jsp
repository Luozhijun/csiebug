...
<html>
	...
	<body>
		<form id="jqPlotChart" name="jqPlotChart" action="<%=webutil.getBasePathForHTML()%>example/jqPlotChart" method="POST">
			...
			<h4>Cursor line and data tracking example</h4>
			
			<h5>JSP 程式碼:</h5>
			
			<c:code>
				<JQPlotChart chartId="chart1" list="lineData5" chartSeriesList="seriesList11" chartXaxisRenderer="$.jqplot.LogAxisRenderer" chartXTickOptionsFormatString="$%.2f" chartYaxisRenderer="$.jqplot.LogAxisRenderer" chartYTickOptionsFormatString="$%.2f" chartCursorShowVerticalLine="true" chartCursorShowHorizontalLine="false" chartCursorShowCursorLegend="true" chartCursorZoom="true" chartCursorShowTooltip="false" />
			</c:code>
			...
			<cc:JQPlotChart chartId="chart1" list="lineData5" chartSeriesList="seriesList11" chartXaxisRenderer="$.jqplot.LogAxisRenderer" chartXTickOptionsFormatString="$%.2f" chartYaxisRenderer="$.jqplot.LogAxisRenderer" chartYTickOptionsFormatString="$%.2f" chartCursorShowVerticalLine="true" chartCursorShowHorizontalLine="false" chartCursorShowCursorLegend="true" chartCursorZoom="true" chartCursorShowTooltip="false" />
