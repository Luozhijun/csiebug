...
<html>
	...
	<body>
		<form id="jqPlotChart" name="jqPlotChart" action="<%=webutil.getBasePathForHTML()%>example/jqPlotChart" method="POST">
			...
			<h4>Date Axes Example</h4>
			
			<h5>JSP 程式碼:</h5>
			
			<c:code>
			<JQPlotChart chartId="chart1" list="lineData7" chartTitleText="Default Date Axis" chartXaxisRenderer="$.jqplot.DateAxisRenderer" chartSeriesList="seriesList8" />
			<JQPlotChart chartId="chart2" list="lineData7" chartTitleText="Customized Date Axis" chartXaxisRenderer="$.jqplot.DateAxisRenderer" chartXTickOptionsFormatString="%b %#d, %y" chartXaxisMin="May 30, 2008" chartXaxisTickInterval="1 month" chartSeriesList="seriesList8" />
			</c:code>
			...
			<cc:JQPlotChart chartId="chart1" list="lineData7" chartTitleText="Default Date Axis" chartXaxisRenderer="$.jqplot.DateAxisRenderer" chartSeriesList="seriesList8" />
			<cc:JQPlotChart chartId="chart2" list="lineData7" chartTitleText="Customized Date Axis" chartXaxisRenderer="$.jqplot.DateAxisRenderer" chartXTickOptionsFormatString="%b %#d, %y" chartXaxisMin="May 30, 2008" chartXaxisTickInterval="1 month" chartSeriesList="seriesList8" />
