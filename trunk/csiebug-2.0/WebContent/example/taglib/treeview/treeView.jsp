...
<html>
	...
	<body>
		<form id="treeView" name="treeView" action="<%=webutil.getBasePathForHTML()%>example/treeView" method="POST">
			<!-- 程式標頭 -->
			<table width="100%">
				<tr>
			...
			<fieldset style="background:lightblue">
				<legend onClick="openSidebarFolder('list')" style="cursor:pointer">屬性list: 從request attribute中取出treeView資料</legend>
