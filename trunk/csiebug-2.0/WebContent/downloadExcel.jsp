...
<html>
	...
	<body>
		<form id="downloadExcel" name="downloadExcel" action="<%=webutil.getBasePathForHTML()%>index" method="POST" target="_self">
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					document.getElementById("ActFlag").value = "downloadExcel";
