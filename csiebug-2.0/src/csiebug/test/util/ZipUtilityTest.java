...
public class ZipUtilityTest {
	...
	public void testZip() throws IOException {
		...
		File zipFile = new File("/home/csiebug/test.zip");
		File txtFile = new File("/home/csiebug/testZip.txt");
	...
	public void testUnzip() throws ZipException, IOException {
		...
		File zipFile = new File("/home/csiebug/test.zip");
		File txtFile = new File("/home/csiebug/testZip.txt");
		File dir2 = new File("/home/csiebug/test2");
		...
		zipUtility.unzip(zipFile, "/home/csiebug/test2");
		
		assertEquals(true, dir2.exists());
		File txtFile2 = new File("/home/csiebug/test2/testZip.txt");
		File dir3 = new File("/home/csiebug/test2/test");
		File dir4 = new File("/home/csiebug/test2/test/test2");
	...
	private File prepareData() throws IOException {
		...
		String filePath1 = "/home/csiebug/testZip.txt";
		String filePath2 = "/home/csiebug/test/test_" + today.get(Calendar.YEAR) + (today.get(Calendar.MONTH) + 1) + today.get(Calendar.DAY_OF_MONTH) + ".txt";
		String filePath3 = "/home/csiebug/test/test2/test_" + today.get(Calendar.YEAR) + (today.get(Calendar.MONTH) + 1) + today.get(Calendar.DAY_OF_MONTH) + ".txt";
		String strContent = "hello world!";
		File file = null;
		File file2 = null;
		File file3 = null;
		File dir = new File("/home/csiebug/test");
