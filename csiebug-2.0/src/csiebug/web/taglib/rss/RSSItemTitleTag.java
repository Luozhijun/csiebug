...
public class RSSItemTitleTag extends BodyTagSupport implements TryCatchFinally {
	...
	public int doStartTag() throws JspException {
		try {
            ...
            HtmlRSSItemAttribute itemAttribute = new HtmlRSSItemAttribute(item, "title");
	...
	public void doCatch(Throwable e) throws Throwable {
		throw new JspException("RSSItemTitleTag Problem: " + e.getMessage());
    }
