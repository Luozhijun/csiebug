...
import csiebug.web.html.treeview.HtmlMenu;
...
public class MenuTag extends BodyTagSupport implements TryCatchFinally {
	...
	public int doStartTag() throws JspException {
		try { 
            ...
            if(list != null && pageContext.getRequest().getAttribute(list) != null) {
            	...
            	HtmlMenu htmlMenu = new HtmlMenu(htmlId, treelist, imagePath, targetFrame);
            		
            	strHtml = htmlMenu.getMenu();
            }
	...
	public void doCatch(Throwable e) throws Throwable {
        throw new JspException("MenuTag Problem: " + e.getMessage());
    }
