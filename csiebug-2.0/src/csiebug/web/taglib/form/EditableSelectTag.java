...
import csiebug.web.html.form.HtmlEditableSelect;


/**
 * EditableSelectField tag
 * @author George_Tsai
 * @version 2009/2/14
 */
public class EditableSelectTag extends BodyTagSupport implements TryCatchFinally {
	...
	public int doStartTag() throws JspException {
		try { 
            ...
            HtmlEditableSelect editableSelect = new HtmlEditableSelect(htmlId, name, isReadOnly, className, isReturnValue, defaultValue, onChange, header, headerClass, footer, footerClass, isRequired, userValue, style, option, Boolean.parseBoolean(caseSensitive), op, typesetting);
	...
	public void doCatch(Throwable e) throws Throwable {
        throw new JspException("EditableSelectTag Problem: " + e.getMessage());
    }
