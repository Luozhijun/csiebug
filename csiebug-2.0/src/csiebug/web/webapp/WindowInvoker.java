...
public abstract class WindowInvoker {
    ...
    public URL processActionInternal(HttpServletRequest request,
        ...
        ContainerFactory.getContainer(ContainerType.PORTLET_CONTAINER);
        String processURL = getActionURL(request, currentPortletWindowMode, currentWindowState);
        // Request
	...
	protected void populateContainerRequest(
            ...
            HttpServletRequest request,
            @SuppressWarnings("rawtypes") List allowableWindowStates,
            @SuppressWarnings("rawtypes") List allowablePortletWindowModes) throws InvokerException {
    ...
    protected StringBuffer getErrorMessageContent(ErrorCode errorCode, Locale locale) {
    ...
    private ResourceBundle getWindowInvokerBundle(Locale locale) {
        if(windowInvokerRB == null) {
            windowInvokerRB = ResourceBundle.getBundle(WINDOW_INVOKER_RB_NAME, locale,getClass().getClassLoader());
        }
