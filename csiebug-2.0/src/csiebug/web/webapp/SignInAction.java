...
public class SignInAction extends BasicAction {
	...
	private void createUser2LDAP() throws NamingException, NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException, InvalidKeySpecException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, DecoderException {
		LdapClient client = new LdapClient(getEnvVariable("ldapURL"), getEnvVariable("ldapAdmin"), DesCoder.decryptCode(getEnvVariable("ldapEncryptPassword"), getEnvVariable("ldapKey")));
