...
public class PersonalSettingAction {
	...
	private void modifyPassword() throws ServiceException, NoSuchAlgorithmException, UnsupportedEncodingException, NamingException, InvalidKeyException, InvalidKeySpecException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, DecoderException {
		try {
			modifyPassword2LDAP();
			modifyPassword2DB();
		} catch(Exception ex) {
	...
	private void modifyPassword2LDAP() throws NamingException, NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException, InvalidKeySpecException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, DecoderException {
	...
	private void rollback() throws NamingException, NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException, InvalidKeySpecException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, DecoderException {
		LdapClient client = new LdapClient(action.getEnvVariable("ldapURL"), action.getEnvVariable("ldapAdmin"), DesCoder.decryptCode(action.getEnvVariable("ldapEncryptPassword"), action.getEnvVariable("ldapKey")));
