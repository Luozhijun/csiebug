...
//        		}
        	...
        	if(hideable == null || AssertUtility.isTrue(hideable)) {
        		htmlBuilder.onClick("hideOrShowColumnForExcel('" + table.getId() + "', " + table.getHeaderRowCount() + ", " + (row.getCurrentColumnIndex() + 1) + ", true);");
...
//        	} else {
//        		if((dataType == null || !dataType.equalsIgnoreCase("excelRowControl")) && !AssertUtility.isFalse(selectable)) {
//        			htmlBuilder.onClick("selColumnForExcel('" + table.getId() + "', " + table.getHeaderRowCount() + ", " + (row.getCurrentColumnIndex() + 1) + ", event);");
//        		}
        	}
        } else { //資料列處理
        	try {
//	          	設定各樣屬性
	            ...
	            if(dataType != null && dataType.equalsIgnoreCase("excelRowControl")) {
	        		htmlBuilder.onClick("selOneDataForClickForExcel('" + table.getId() + "', " + (table.getHeaderRowCount() + table.getCurrentMapIndex()) + ", 0, " + table.getHeaderRowCount() + ", event);");
	        	} else {
		            ...
		            if(!AssertUtility.isTrue(row.getSelectable()) && !AssertUtility.isFalse(selectable)) {
		            	...
		            	if(onClick != null) {
		            		htmlBuilder.onClick("selTDForCopyForExcel('" + table.getId() + "', this, " + (table.getHeaderRowCount() + table.getCurrentMapIndex()) + ", " + (row.getCurrentColumnIndex() + 1) + ", " + table.getHeaderRowCount() + ", event, '" + webutil.getMessage("common.warning") + "', '" + webutil.getMessage("common.confirm.copy") + "', '" + webutil.getMessage("common.ok") + "', '" + webutil.getMessage("common.cancel") + "');" + transScript(onClick));
		            		...
		            		if(onDblClick != null) {
		            			htmlBuilder.onDblClick("selTDForCopyForExcel('" + table.getId() + "', this, " + (table.getHeaderRowCount() + table.getCurrentMapIndex()) + ", " + (row.getCurrentColumnIndex() + 1) + ", " + table.getHeaderRowCount() + ", event, '" + webutil.getMessage("common.warning") + "', '" + webutil.getMessage("common.confirm.copy") + "', '" + webutil.getMessage("common.ok") + "', '" + webutil.getMessage("common.cancel") + "');" + transScript(onDblClick));
		            		} else {
			            		htmlBuilder.onClick("selTDForCopyForExcel('" + table.getId() + "', this, " + (table.getHeaderRowCount() + table.getCurrentMapIndex()) + ", " + (row.getCurrentColumnIndex() + 1) + ", " + table.getHeaderRowCount() + ", event, '" + webutil.getMessage("common.warning") + "', '" + webutil.getMessage("common.confirm.copy") + "', '" + webutil.getMessage("common.ok") + "', '" + webutil.getMessage("common.cancel") + "');");
			            	}
		            	}
		            } else {
		            	if(onClick != null) {
				...
				if(!AssertUtility.isNotNullAndNotSpace(value)) {
					...
					if(dataType != null) {
						if(dataType.equalsIgnoreCase("selAllCheckBox")) {
		            		...
		            		label.setOnChange("sendAJAXRequestForExcelField('" + table.getFormId() + "', '" + table.getId() + "', this);");
