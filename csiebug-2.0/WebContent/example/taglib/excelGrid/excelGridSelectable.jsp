...
<html>
	...
	<body>
		...
		<form id="excelGrid" name="excelGrid" action="<%=webutil.getBasePathForHTML()%>example/excelGrid" method="POST">
		    ...
		    <c:code>
		    <table id="test" data="gridData" projectId="templateProject" formId="excelGrid" downloadColumns="3,4,5">
				<row >
					<column fieldname="field1" selectable="false"/>
					<column fieldname="field2" selectable="false"/>
			...
			<excel:table id="test" data="gridData" projectId="templateProject" formId="excelGrid" downloadColumns="3,4,5">
				<excel:row >
					<excel:column fieldname="field1" selectable="false"/>
					<excel:column fieldname="field2" selectable="false"/>
