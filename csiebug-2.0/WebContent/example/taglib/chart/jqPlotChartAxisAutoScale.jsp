...
<html>
	...
	<body>
		<form id="jqPlotChart" name="jqPlotChart" action="<%=webutil.getBasePathForHTML()%>example/jqPlotChart" method="POST">
			...
			<h4>Axis Auto Scale Example</h4>
			
			<h5>JSP 程式碼:</h5>
			
			<c:code>
			<JQPlotChart chartId="chart1" list="lineData5" />
			<JQPlotChart chartId="chart2" list="lineData5" chartYTickOptionsFormatString="%.3f"/>
			<JQPlotChart chartId="chart3" list="lineData5" chartYaxisAutoscale="true"/>
			<JQPlotChart chartId="chart4" list="lineData5" chartYaxisAutoscale="true" chartYTickOptionsFormatString="%.3f"/>
			</c:code>
			...
			<cc:JQPlotChart chartId="chart1" list="lineData5" />
			<cc:JQPlotChart chartId="chart2" list="lineData5" chartYTickOptionsFormatString="%.3f"/>
			<cc:JQPlotChart chartId="chart3" list="lineData5" chartYaxisAutoscale="true"/>
			<cc:JQPlotChart chartId="chart4" list="lineData5" chartYaxisAutoscale="true" chartYTickOptionsFormatString="%.3f"/>
