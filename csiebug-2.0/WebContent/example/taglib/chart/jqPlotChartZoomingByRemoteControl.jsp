	...
	<body>
		<form id="jqPlotChart" name="jqPlotChart" action="<%=webutil.getBasePathForHTML()%>example/jqPlotChart" method="POST">
			...
			<c:code>
				...
				<script language="javascript" type="text/javascript" src="<%=webutil.getBasePathForHTML()%>js/jqplot.0.9.7/plugins/jqplot.cursor.min.js"></script>
			...
			<h4>Zooming by remote control example</h4>
			
			<h5>JSP 程式碼:</h5>
			
			<c:code>
				<JQPlotChart chartId="chart1" list="lineData5" style="height:300px; width:450px;" chartCursorZoom="true" chartCursorShowTooltip="false" />
				<JQPlotChart chartId="chart2" list="lineData5" style="height:120px; width:180px;" chartCursorZoom="true" chartCursorShowTooltip="false" />
				<JQPlotChart chartId="chart3" list="lineData5" style="height:120px; width:180px;" chartCursorZoom="true" chartCursorShowTooltip="false" chartCursorConstrainZoomTo="x" />
			</c:code>
			
			<hr>
			
			<h5>Javascript 程式碼:</h5>
			
			<c:code>
				$.jqplot.Cursor.zoomProxy(chart1, chart2);
				$.jqplot.Cursor.zoomProxy(chart1, chart3);
			</c:code>
			...
			<cc:JQPlotChart chartId="chart1" list="lineData5" style="height:300px; width:450px;" chartCursorZoom="true" chartCursorShowTooltip="false" />
			<cc:JQPlotChart chartId="chart2" list="lineData5" style="height:120px; width:180px;" chartCursorZoom="true" chartCursorShowTooltip="false" />
			<cc:JQPlotChart chartId="chart3" list="lineData5" style="height:120px; width:180px;" chartCursorZoom="true" chartCursorShowTooltip="false" chartCursorConstrainZoomTo="x" />
