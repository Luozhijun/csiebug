...
<html>
	...
	<body>
		<form id="jQueryProgressBar" name="jQueryProgressBar" action="<%=webutil.getBasePathForHTML()%>example/jQueryProgressBar" method="POST">
			<!-- 程式標頭 -->
			<table width="100%">
				<tr>
			...
			<fieldset style="background:lightblue">
				...
				<div id="uncomplete_sidebar" style="display:none">
					...
					<c:code>
					<jQueryProgressbar uncomplete="30"/><br>
					<jQueryProgressbar uncomplete="70"/><br>
					<jQueryProgressbar uncomplete="100"/><br>
					<jQueryProgressbar uncomplete="120"/><br>
					</c:code>
					...
					<c:jQueryProgressbar uncomplete="30"/><br>
					<c:jQueryProgressbar uncomplete="70"/><br>
					<c:jQueryProgressbar uncomplete="100"/><br>
					<c:jQueryProgressbar uncomplete="120"/><br>
