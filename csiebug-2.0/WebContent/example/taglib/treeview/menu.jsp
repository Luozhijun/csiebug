...
<html>
	...
	<body>
		<form id="menu" name="menu" action="<%=webutil.getBasePathForHTML()%>example/menu" method="POST">
			<!-- 程式標頭 -->
			<table width="100%">
				<tr>
			...
			<fieldset style="background:lightblue">
				<legend onClick="openSidebarFolder('list')" style="cursor:pointer">屬性list: 從request attribute中取出menu資料</legend>
			...
			<script src="<%=webutil.getBasePathForHTML()%>js/csiebug-treeview/csiebug-menu.js"></script>
