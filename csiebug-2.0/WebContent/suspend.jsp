...
<html>
	<head>
		...
		<title><%=webutil.getMessage("common.ServiceSuspend")%></title>
	</head>
	<body>
			<!-- 程式標頭 -->
			<table width="100%">
				<tr>
					<td class="PageHeader"><%=webutil.getMessage("common.ServiceSuspend")%></td>
				</tr>
			</table>
			
			<!-- 以下為頁面編輯區 -->
			
			<%=webutil.getMessage("common.ServiceSuspend")%><br>
